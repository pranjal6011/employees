...
entity Employees : managed {
  ...
  learnings    : Composition of many Learnings on learnings.employee = $self;
  ratings      : Composition of many Ratings on ratings.employee = $self;
}
